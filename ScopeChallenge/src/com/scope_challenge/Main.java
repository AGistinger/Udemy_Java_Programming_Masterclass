 ...
 * Scanner instance.  You can use as many other variables as you need,
 * but they must all be called x.  That includes any class instances
 * and loop control variables that you may decide to use.
 *
