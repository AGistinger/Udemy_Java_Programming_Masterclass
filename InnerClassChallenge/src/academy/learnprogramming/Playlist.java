...
public class Playlist {
    ...
    private boolean songExists(String title) {
        for(Album album : this.albums) {
            return album.getSongs().findSong(title) != null;
        }
        return false;
    }
    ...
    private Song findSong(String title) {
        Song song = null;
        for(Album album : this.albums) {
            song = findAlbum(album.getTitle()).getSongs().findSong(title);
        }
        return song;
    }
    ...
    private void nextSong() {
        System.out.println(this.currentSong.hasNext()); // always true
    ...
    public void addSongToPlaylist(String song) {
        for(Album album : albums) {
            if(album.getSongs().findSong(song) != null) {
                this.playlist.add(album.getSongs().findSong(song));
