...
public class Main {
    public static void main(String[] args) {
        ...
        // Pass lambda to a method as a parameter
        String result = everySecondCharacter(lambdaFunction, "123457890");
        System.out.println(result);

        // Supplier interface with lambda
        Supplier<String> iLoveJava = () -> "I love Java!";

        // Use supplier to assign string to a variable
        String supplierResult = iLoveJava.get();
        System.out.println(supplierResult);

        // USe lambas to print out list in alphabetical order and first letter uppercase
        List<String> topNames2015 = Arrays.asList(
                "Amelia", "Olivia", "Emily", "Isla",
                "Ava", "Oliver", "Jack", "Charlie",
                "Harry", "Jacob"
        );
